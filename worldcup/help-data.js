...
(function (root, factory) {
  ...
  const cards = [
    ...
    { group: 'Stickers', id: 'stk-scan', icon: '📷',
      title: 'Add a sticker by its code',
      summary: 'Know the code on the sticker? Type it in to mark it fast.',
      steps: ['Open 🎟️ Stickers → 📖 My Book', 'Tap ➕ Add by code',
              'Type the code printed on the sticker (like MEX5)', 'Tap Add +1',
              'Tip: tapping a sticker in the grid also marks Have → spare → and back'] },
    ...
    { group: 'Extras & settings', id: 'extras', icon: '✨',
      ...
      steps: ['Leave it idle and a fun screensaver appears — touch to wake it',
              'In ⚙️ Settings, use “add to calendar (.ics)” to save game times to your phone',
              'On 🗂️ Bracket, tap 📤 Share to make a QR of your bracket for someone to scan'] },
